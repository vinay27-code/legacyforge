...
hljs.registerLanguage('jsp', xmlLang; // JSP looks a lot like XML for hljs
...
@Component({
          ...
          <section class="viewer">
            @if (currentFile( {
              ...
              @if (currentFile(!.binary || currentFile(!.content === null {
                ...
                <pre class="code"><code #codeEl [innerHTML]="highlighted("></code></pre>
              }
            } @else {
  ...
  styles: [`
    ...
    .source-link {
      color: var(--lf-muted; font-size: 0.9rem; display: inline-flex; align-items: center; gap: 4px;
    }
    .split {
    ...
    /* highlight.js dark theme (inline so we don't need to import a whole CSS file */
    .code ::ng-deep .hljs-keyword,
    .code ::ng-deep .hljs-selector-tag,
    .code ::ng-deep .hljs-built_in { color: #ff8c42; }
    .code ::ng-deep .hljs-string,
    .code ::ng-deep .hljs-attr,
    .code ::ng-deep .hljs-template-string { color: #a5e075; }
    .code ::ng-deep .hljs-number,
    .code ::ng-deep .hljs-literal { color: #ffb86c; }
    .code ::ng-deep .hljs-comment,
    .code ::ng-deep .hljs-quote { color: #6c7a99; font-style: italic; }
    .code ::ng-deep .hljs-type,
    .code ::ng-deep .hljs-class .hljs-title,
    .code ::ng-deep .hljs-title.class_ { color: #63b3ed; }
    .code ::ng-deep .hljs-function .hljs-title,
    .code ::ng-deep .hljs-title.function_ { color: #ffd866; }
    .code ::ng-deep .hljs-variable,
    .code ::ng-deep .hljs-name,
    .code ::ng-deep .hljs-tag { color: #f0f4ff; }
    .code ::ng-deep .hljs-attribute { color: #78dce8; }
    .code ::ng-deep .hljs-meta,
    .code ::ng-deep .hljs-doctag { color: #78dce8; }
    .code ::ng-deep .hljs-symbol,
    .code ::ng-deep .hljs-bullet { color: #ff6188; }
  `],
}
